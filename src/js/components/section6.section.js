...
const CONFIGS = {
    sun: {
        accent: 'Luz Natural',
        icon: '☀️',
        tags: ['☀️ El Sol', '⭐ Las Estrellas', '⚡ Los Rayos'],
        fact: '¡La luz del Sol tarda 8 minutos en llegar a la Tierra!',
        factIcon: '🚀',
        buildVisual(card) {
            card.innerHTML = `
    ...
    lamp: {
        accent: 'Luz Artificial',
        icon: '💡',
        tags: ['💡 Lámparas', '🔦 Linternas', '🏮 Luminarias'],
        fact: '¡Las luces LED gastan mucha menos energía que los focos antiguos!',
        factIcon: '⚡',
        buildVisual(card) {
    ...
    rainbow: {
        accent: 'Colores de Luz',
        icon: '🌈',
        tags: ['🔴 Rojo', '🟢 Verde', '🔵 Azul'],
        fact: '¡Al mezclar luz roja, verde y azul se obtiene luz blanca!',
        factIcon: '🌈',
        buildVisual(card) {
            const bands = [
    ...
    shadow: {
        accent: 'Las Sombras',
        icon: '🌑',
        tags: ['📦 Cuerpos Opacos', '🌑 Sombras', '🔦 Bloqueo de luz'],
        fact: '¡Tu sombra es más larga por las mañanas y las tardes que al mediodía!',
        factIcon: '🌅',
        buildVisual(card) {
            card.innerHTML = `
    ...
    glass: {
        accent: 'Transparencia',
        icon: '🪟',
        tags: ['🪟 Vidrio', '📄 Celofán', '💧 Agua'],
        fact: '¡El papel celofán deja pasar la luz pero le cambia el color!',
        factIcon: '✨',
        buildVisual(card) {
            card.innerHTML = `

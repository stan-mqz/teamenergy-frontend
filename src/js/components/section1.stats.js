...
function buildChart(data) {
    ...
    requestAnimationFrame(() => {
        const canvas = wrap.querySelector("#stats-bar-chart-1");
...
export async function createStats1() {
    await loadChartJs();
    ...
    section.innerHTML = `
        <div class="stats-header">
            <span class="stats-eyebrow">Sección 1 · Energía Mecánica</span>
    ...
    try {
        ...
        console.error("[createStats1] Error:", err);
